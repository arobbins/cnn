...
set :wp_user, "arobbins" # The admin username
set :wp_email, "arobbins@simpleblend.net" # The admin email address
set :wp_sitename, "CNN" # The site title
set :wp_localurl, "http://cnn.dev" # Your local environment URL
...
set :application, "CNN"
set :repo_url, "git@github.com:arobbins/cnn.git"
set :scm, :git
